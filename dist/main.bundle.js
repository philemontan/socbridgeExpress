...
var ChatComponent = (function () {
    ...
    ChatComponent.prototype.ngOnInit = function () {
        ...
        this.route.parent.params
            ...
            _this.socket.emit('unsubscribe', _this.currUser.firstName);
...
var SidebarComponent = (function () {
    ...
    SidebarComponent.prototype.onToggle = function (event) {
        event.clicked = true;
...
var IVLEComponent = (function () {
    ...
    IVLEComponent.prototype.ngOnInit = function () {
        ...
        this.httpService.populate(this.lapiUrl)
            ...
            _this.user = JSON.parse(data.userObj).firstName;
            console.log(data.ivleRetrievedModules);
            var tempArr = data.moduleArrObj.modules;
            console.log(tempArr);
            _this.ivleRetrievedModules = tempArr;
...
var Module = (function () {
    function Module(name, users, clicked) {
...
var UsersService = (function () {
    ...
    UsersService.prototype.initializeUserData = function () {
        ...
        for (var i = 0; i < BEmodArr.length; i++) {
            tempMod = BEmodArr[i];
            this.FEmodArr.push(new __WEBPACK_IMPORTED_MODULE_1__models_Module_model__["a" /* Module */](tempMod.module_code, [], false));
    ...
    UsersService.prototype.setSocket = function (socket) {
        this.socket = socket;
    };
    UsersService.prototype.onToggle = function (mod) {
        for (var _i = 0, _a = this.FEmodArr; _i < _a.length; _i++) {
            var module = _a[_i];
            if (mod !== module) {
...
// module
exports.push([module.i, "errorMessage {\r\n  color: red;\r\n}\r\n\r\n\r\n.coloring_class {\r\n  background-color: #C4DFE6;\r\n  min-height: 100%;\r\n}\r\n\r\n/*body {*/\r\n/*min-height: 100%;*/\r\n/*background-color: #3c8dbc;*/\r\n/*}*/\r\n\r\nhtml, body {\r\n  height: 100%;\r\n  margin: 0;\r\n  padding: 0;\r\n  background-color: #3c8dbc;\r\n}\r\n\r\n/*#doc3 {*/\r\n/*margin: auto 10px;*/\r\n/*width: 100%;*/\r\n/*height: 1000px;*/\r\n/*background-color: #3c8dbc;*/\r\n/*}*/\r\n.fullheight.jumbotron {\r\n  position: relative;\r\n  background-size: cover;\r\n  min-height: 100vh;\r\n  background-color: #C4DFE6;\r\n  padding-bottom: 0;\r\n  margin-bottom: 0;\r\n}\r\n\r\n#logo {\r\n  float: left;\r\n  font-size: 1.7em;\r\n  color: #fff;\r\n  text-transform: uppercase;\r\n  font-weight: bold;\r\n  letter-spacing: -1px;\r\n}\r\n\r\n#logo:hover {\r\n  color: #fff;\r\n  text-decoration: none;\r\n}\r\n\r\n.centre {\r\n  text-align: center;\r\n}\r\n\r\n.jumbotron {\r\n  background-image: url('http://influencerconnect.com/wp-content/uploads/2015/03/home-page-header-dark.jpg');\r\n  background-size: cover;\r\n  height: 550px;\r\n  padding-bottom: 0;\r\n  margin-bottom: 20px;\r\n  margin-top: 20px;\r\n}\r\n\r\n.jumbotron h1 {\r\n  color: white;\r\n  text-align: center;\r\n  font-weight: bold;\r\n  letter-spacing: -1px;\r\n}\r\n\r\n.btn-change {\r\n  background: black;\r\n  position: inherit;\r\n}\r\n\r\n.navbar {\r\n  margin-top: 0;\r\n  margin-bottom: 0;\r\n  padding: 35.5px\r\n}\r\n", ""]);
...
// module
exports.push([module.i, ".btn-primary {\r\n  color: #fff;\r\n  background-color: #ef9534;\r\n  border-color: #EF7C00;\r\n}\r\nh1 {\r\n  text-align: center;\r\n  font-weight: bold;\r\n}\r\n\r\n.centre {\r\n  text-align: center;\r\n}\r\n\r\n.jumbotron {\r\n  background-image: url('https://community.nus.edu.sg/ecards/images/campuslife/campuslife_16_7.jpg');\r\n  background-size: 100% 100%;\r\n  height: 550px;\r\n  padding-bottom: 0;\r\n  margin-bottom: 20px;\r\n  margin-top: 20px;\r\n}\r\n\r\n.jumbotron h1 {\r\n  color: black;\r\n  text-align: center;\r\n  font-weight: bold;\r\n  letter-spacing: -1px;\r\n}\r\n\r\n.btn-change {\r\n  background: black;\r\n  position: inherit;\r\n}\r\n\r\n.navbar {\r\n  margin-top: 0;\r\n  margin-bottom: 0;\r\n  padding: 35.5px\r\n}\r\n", ""]);
...
module.exports = "<div class=\"stop\">\r\n  <div class=\"row\">\r\n    <div class=\"col-xs-3\" style=\"position:fixed;height:100%; padding-right: 0; margin-right: 0\">\r\n      <app-sidebar style=\"z-index: 9999\"></app-sidebar>\r\n    </div>\r\n    <div class=\"col-xs-9 full cover\" style=\"margin-left: 200px\">\r\n      <router-outlet  style=\"position: fixed\"></router-outlet>\r\n    </div>\r\n  </div>\r\n</div>\r\n"
...
module.exports = "<div class=\"container\">\r\n  <div class=\" centre jumbotron\">\r\n    <h1>Welcome, {{user}}</h1>\r\n    <h2>These modules are registered to you. Please proceed to Login: <button class=\"btn btn-lg btn-success\" (click)=\"continue()\">Continue</button></h2>\r\n    <ul class=\"list-group\">\r\n      <li *ngFor=\"let mod of ivleRetrievedModules;\r\n                  let i = index\"\r\n          [ngClass]=\"{'alt-mod-display':i%2===0}\"\r\n          class=\"list-group-item\">{{mod}}\r\n      </li>\r\n    </ul>\r\n  </div>\r\n</div>\r\n"
...
module.exports = "<div class=\"container\">\r\n  <h1>We would need you to connect to IVLE in order to retrieve your credentials</h1>\r\n  <div class=\"jumbotron\" style=\"text-align: center\">\r\n  </div>\r\n  <a href=\"https://ivle.nus.edu.sg/api/login/?apikey=Nxm9ocEZtuEeyUn3ed4Ci&url=http://{{herokuDomainStr}}/IVLE\" class=\"btn btn-lg btn-primary btn-block NUS \">IVLE</a>\r\n</div>\r\n"
